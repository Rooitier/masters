...
// Graphs and canvas
TCanvas *c1 = new TCanvas ("My Plot","Graph Draw Options",10,10,800,600);
c1->SetLogy();
...
mg->GetXaxis()->SetRangeUser(6,13.5);
mg->GetYaxis()->SetRangeUser(1.5E-10,1.5E-7);
...
legend->AddEntry(gr, "{}^{45}Sc(p,#gamma) Zalubovski et al. (1994)","p");
legend->AddEntry(grr,"Brink-Axel PSF (1994)","lp");
legend->AddEntry(gr1,"{}^{45}Sc(p,#gamma) Fedorets et al. (2008)","p");
legend->AddEntry(gr2,"Brink-Axel PSF (2008)","lp");
