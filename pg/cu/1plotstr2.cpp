...
legend->AddEntry(gr, "{}^{65}Cu(p,#gamma) Erlandsson (1979)","p");
legend->AddEntry(grr,"Brink-Axel PSF (Erlandsson, 1979)","lp");
legend->AddEntry(gr1,"{}^{65}Cu(p,#gamma) Nemashkalo et al. (1983)","p");
legend->AddEntry(gr2,"Brink-Axel PSF (Nemashkalo, 1983)","lp");
