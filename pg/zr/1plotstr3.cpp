void plot(const char* file1, const char* file2, const char* file3, const char* file4, const char* file5, const char* file6, const char* file7,const char* file8){
...
legend->AddEntry(gr1, "{}^{90}Zr(p,#gamma) Szeflinska et al. (1979)","p");
legend->AddEntry(gr,"Brink-Axel PSF (Szeflinska, 1979)","lp");
legend->AddEntry(gr2,"{}^{90}Zr(p,#gamma) Szeflinkska et al. (1983)","p");
legend->AddEntry(grr,"Brink-Axel PSF (73As,1979)","lp");
legend->AddEntry(gr3, "{}^{90}Zr(p,#gamma) Fedorets et al. (2003)","p");
legend->AddEntry(grrr,"Brink-Axel PSF (Fedorets, 2003)","lp");
legend->AddEntry(gr4,"{}^{90}Zr(p,#gamma) Netterdon et al. (2015)","p");
legend->AddEntry(grrrr,"Brink-Axel PSF (Netterdon, 2015)","lp");
