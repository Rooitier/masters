...
legend->AddEntry(gr, "{}^{66}Zn(p,#gamma) Erlandsson et al. (1980)","p");
legend->AddEntry(grr,"Brink-Axel PSF (1980)","lp");
legend->AddEntry(gr1,"{}^{66}Zn(p,#gamma) Nemashkalo et al. (2003)","p");
legend->AddEntry(gr2,"Brink-Axel PSF (2003)","lp");
