...
legend->AddEntry(gr, "{}^{57}Co(p,#gamma) Nemashkalo et al. (1982)","p");
legend->AddEntry(grr,"Brink-Axel PSF (1982)","lp");
legend->AddEntry(gr1,"{}^{57}Co(p,#gamma) Ratkevich et al. (2000)","p");
legend->AddEntry(gr2,"Brink-Axel PSF (2000)","lp");
