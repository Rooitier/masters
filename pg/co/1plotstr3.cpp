...
legend->AddEntry(gr1, "{}^{59}Co(p,#gamma) Nilson (1982)","p");
legend->AddEntry(gr,"Brink-Axel PSF (Nilson, 1982)","lp");
legend->AddEntry(gr2,"{}^{59}Co(p,#gamma) Nemashkalo et al. (1982)","p");
legend->AddEntry(grr,"Brink-Axel PSF (Nemashkalo, 1982)","lp");
legend->AddEntry(gr3, "{}^{59}Co(p,#gamma) Ratkevich et al. (2000)","p");
legend->AddEntry(grrr,"Brink-Axel PSF (2000)","lp");
